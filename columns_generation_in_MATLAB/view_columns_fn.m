function view_columns_fn(ID,input_dir,output_dir)
...
if ~isfile(strcat(output_dir, ID, '/columns/', ID,'_column_lh_dwi.mat'))
    fprintf('Subject %s doesnt have columns files', ID);
    return
end
