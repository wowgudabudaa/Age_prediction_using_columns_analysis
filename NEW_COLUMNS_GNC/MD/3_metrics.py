...
df_preds = pd.read_csv(r"Brain_column_analyse/NEW COLUMNS GNC/MD/column_model_predictions_all_subjects_with_cBAG.csv")
...
df_meta = pd.read_excel("AD_DECODE_data3.xlsx")
