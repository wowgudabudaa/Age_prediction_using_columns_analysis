...
MODEL_DIRS = {
    "QSM+MD+Thickness": "NEW COLUMNS GNC/MD+thickness+QSM_dual_channel/"
}

TRAIN_PATTERN = "column_md_results/*train_results*_ref.csv"
TEST_PATTERN  = "column_MCIandAD/*test_results*_ref.csv"
...
def main():
    ...
    for model, d in MODEL_DIRS.items():
        ...
        g.to_csv(outdir / f"{model}_subject_level_{args.agg}_raw_and_quadratic_corrected_{args.calib}_MCIandAD.csv", index=False)
